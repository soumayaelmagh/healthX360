...
function OurMission() {
  return (
    <section className="page-section w-full h-auto min-h-screen text-center overflow-x-hidden" id="mission">
      ...
      <Reveal
        element={
          <p className="font-medium text-lg md:text-xl lg:text-2xl xl:text-4xl text-black md:text-start xl:mt-20">  Our mission is to clarify the overlooked patterns behind persistent pain through science-based education. We research, simplify, and translate multidimensional insights—revealing the interconnected roles of physiology, psychology, and spiritual well-being.
       </p>
        }
        width="fit-content"
      />
