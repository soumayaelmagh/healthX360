...
function Navbar() {
  ...
  return (
    <>
      <header className="fixed bg-secondary md:bg-white bg-opacity-50 w-full px-5 py-5 md:px-10 md:py-6 xl:px-16 xl:py-8 flex justify-between items-center z-[999] overflow-hidden">
        <Link
          href="/"
